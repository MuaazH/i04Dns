...
// MuaazH: This implementation is shit becaue i don't think you need a pointer to parent.
...
// NewWithIntComparator instantiates a red-black tree with the UInt16Comparator, i.e. keys are of type uint16.
func NewWithUInt16Comparator() *Tree {
	return &Tree{Comparator: util.UInt16Comparator}
}
